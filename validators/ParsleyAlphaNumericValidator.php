...
/**
 * Validator for alpha-numeric values.
 */
class ParsleyAlphaNumericValidator extends CValidator implements ParsleyValidator
{
    ...
    public function registerClientValidation($object, $attribute, &$htmlOptions)
    {
        ...
        $htmlOptions['data-type-alphanum-message'] = $this->getErrorMessage($object, $attribute);
    }
    ...
    public function getErrorMessage($object, $attribute)
    {
        if (isset($this->message)) {
            ...
            $message = Yii::t('validator', 'This value must be alphanumeric.');
        }
        return strtr(
            $message,
            array(
